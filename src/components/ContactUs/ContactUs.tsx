    ...
    <Element name="contactUs">
      <div>
        <div className="flex flex-col lg:flex-row items-center justify-center gap-20 py-10">
          <div className="flex flex-col w-1/2 lg:w-1/4 gap-5">
            ...
            <div className="text-2xl font-medium">
              ...
              <p className="text-wrap text-sm">
                ...
                important to us as we strive to provide exceptional quality to
                our products.
              </p>
            </div>
            <div>
          ...
          <form
            className="flex flex-col gap-5 w-1/2 lg:w-1/4"
            onSubmit={onSubmit}
          >
            ...
            {result !== "" ? (
              <div>
                {result}{" "}
                <FaCheck className="w-5 h-5 text-app-blue inline-block ml-3" />
              </div>
            ) : (
              <></>
            )}
